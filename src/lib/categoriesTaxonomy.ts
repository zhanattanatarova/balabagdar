...
export const TAXONOMY: Group[] = [
  ...
  {
    id: "special", emoji: "💖",
    subs: ["asd", "zprr", "zrr", "onr", "adhd", "correction_center", "surdo", "tiflo", "afk", "lfk", "aba", "sensory", "speech", "logomassage", "psychologist", "neurologist", "massage", "osteopath", "swim", "hippotherapy", "canistherapy", "art", "music", "montessori", "inclusive"],
  },
  {
    id: "health", emoji: "🏥",
