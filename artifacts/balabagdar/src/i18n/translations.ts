...
export const translations = {
  ...
  "auth.choose_method": { ru: "Как хотите войти?", kz: "Қалай кіргіңіз келеді?", en: "How would you like to sign in?" },
  "auth.via_telegram": { ru: "Через Telegram", kz: "Telegram арқылы", en: "Via Telegram" },
  "auth.via_telegram_desc": { ru: "Код придёт в бот", kz: "Код ботқа келеді", en: "Code sent to bot" },
  "auth.via_email": { ru: "Email и пароль", kz: "Email және құпия сөз", en: "Email & password" },
  "auth.via_email_desc": { ru: "Войти или зарегистрироваться", kz: "Кіру немесе тіркелу", en: "Sign in or register" },
  ...
  "auth.email_label": { ru: "Email", kz: "Email", en: "Email" },
  "auth.email_placeholder": { ru: "example@mail.com", kz: "example@mail.com", en: "example@mail.com" },
  "auth.password_label": { ru: "Пароль", kz: "Құпия сөз", en: "Password" },
  "auth.password_placeholder": { ru: "Минимум 6 символов", kz: "Кемінде 6 таңба", en: "At least 6 characters" },
  "auth.confirm_password": { ru: "Повторите пароль", kz: "Құпия сөзді қайталаңыз", en: "Confirm password" },
  "auth.register": { ru: "Создать аккаунт", kz: "Аккаунт жасау", en: "Create account" },
  "auth.login": { ru: "Войти", kz: "Кіру", en: "Sign in" },
  "auth.no_account": { ru: "Нет аккаунта? Зарегистрироваться →", kz: "Аккаунт жоқ па? Тіркелу →", en: "No account? Register →" },
  "auth.have_account": { ru: "Уже есть аккаунт? Войти →", kz: "Аккаунт бар ма? Кіру →", en: "Already have account? Sign in →" },
  "auth.passwords_no_match": { ru: "Пароли не совпадают", kz: "Құпия сөздер сәйкес емес", en: "Passwords do not match" },
  "auth.setup_title": { ru: "Создайте логин", kz: "Логин жасаңыз", en: "Create your login" },
  "auth.setup_desc": { ru: "Задайте email и пароль — это необязательно, можно пропустить", kz: "Email мен пароль орнатыңыз — міндетті емес", en: "Set email & password — optional, you can skip" },
  "auth.setup_skip": { ru: "Пропустить →", kz: "Өткізіп жіберу →", en: "Skip →" },
  "auth.setup_save": { ru: "Сохранить и продолжить", kz: "Сақтап жалғастыру", en: "Save & continue" },
  ...
  "auth.back_to_method": { ru: "← Другой способ", kz: "← Басқа тәсіл", en: "← Other method" },
